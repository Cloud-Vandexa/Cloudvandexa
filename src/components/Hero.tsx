    ...
    <section className="relative h-[700px] bg-zoho-blue text-white overflow-hidden flex flex-col justify-center">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10 w-full flex flex-col items-start pt-20">
        <div className="max-w-3xl">
          <h1 className="text-3xl md:text-5xl font-sansation leading-tight mb-4 text-white">
            Smart Zoho Solutions. <br />
            Real Business Growth.
          </h1>
          <p className="text-xl md:text-2xl font-light font-roboto opacity-90 mb-12 max-w-xl">
            Empowering Businesses to Scale Faster with <br />
            <span className="font-medium">CloudVandexa</span>
          </p>

          <button className="bg-slate-50 text-slate-800 px-12 py-4 rounded-full font-medium text-base hover:shadow-2xl hover:scale-105 transition-all duration-300">
